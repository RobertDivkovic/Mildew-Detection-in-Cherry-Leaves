...
def app():
    ...
    if st.checkbox("Show Average and Variability Images"):
        st.image(
            "/workspaces/Mildew-Detection-in-Cherry-Leaves/outputs/02_data_visualisation/avg_var_healthy.png",
            caption="Healthy Leaf: Average & Variability",
        width=500)
        st.image(
            "/workspaces/Mildew-Detection-in-Cherry-Leaves/outputs/02_data_visualisation/avg_var_powdery_mildew.png",
    ...
    if st.checkbox("Show Difference Between Average Images"):
        st.image(
            "/workspaces/Mildew-Detection-in-Cherry-Leaves/outputs/02_data_visualisation/avg_diff.png",
