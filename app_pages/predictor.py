...
model, image_shape, class_indices = load_model_and_metadata(
    "/workspaces/Mildew-Detection-in-Cherry-Leaves/jupyter_notebooks/outputs/v1/cherry_leaf_mildew_model.h5",
    "/workspaces/Mildew-Detection-in-Cherry-Leaves/outputs/02_data_visualisation/image_shape.pkl",
    "/workspaces/Mildew-Detection-in-Cherry-Leaves/jupyter_notebooks/outputs/03_modelling_and_evaluating/class_indices.pkl"
)
